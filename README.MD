...
This project is licensed under the [MIT License](LICENSE). Which means everything is free to use. We do ask that if you want to use the index page please give credit, but games are free to use.
